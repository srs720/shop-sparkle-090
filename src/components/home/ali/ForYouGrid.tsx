...
export function ForYouGrid() {
  // Repeat the catalog so the feed looks fully populated.
  const feed = [...products, ...products].slice(0, 30);
  return (
        ...
        return (
          ...
          >
            ...
            <div className="space-y-1 p-2">
              <div className="line-clamp-2 text-[12px] leading-tight text-foreground">
                {p.title}
              </div>
              <div className="flex items-baseline gap-1">
                <span className="text-base font-extrabold text-hot">
                  ${p.price}
                </span>
